...
import { LayoutDashboard, BookOpen, ClipboardList, ChevronLeft, Menu, LogOut } from "lucide-react"
import { Button } from "@/components/ui/button"
import { useAuth } from "@/hooks/use-auth"
import { useState } from "react"

const navigation = [
  { name: "Dashboard", href: "/formateur", icon: LayoutDashboard },
  { name: "Mes travaux", href: "/formateur/travaux", icon: ClipboardList },
  { name: "Mes espaces", href: "/formateur/espaces", icon: BookOpen },
]
